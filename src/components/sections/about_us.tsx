  ...
  return (
    <div id="aboutus" className="w-full flex flex-col gap-6 items-center pt-8">
      ...
      <div className="relative w-full">
        ...
        <div className="absolute w-[50%] bottom-5 lg:bottom-36 right-2 text-xs lg:text-3xl">
          大有国際 -
      ...
      <div className="relative w-full">
        <Image
          ...
          className="w-full h-auto"
        />
        <div className="absolute top-2 left-0 lg:top-2 lg:left-2">
          <SubLogo />
        </div>
        <div className="absolute w-[80%] lg:w-[52%] bottom-10 lg:bottom-20 right-4">
          <p className="line-clamp-6 lg:line-clamp-none text-xs lg:text-lg">
