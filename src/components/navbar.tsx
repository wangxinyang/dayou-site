...
const NavLinks = () => {
  return (
    <>
      <Link href="#id" className="block text-xs sm:text-sm relative group">
      ...
      <Link href="#aboutus" className="block text-xs sm:text-sm relative group">
        <span className="relative text-foreground hover:text-primary transition-colors">
          私達について
          <span className="absolute left-0 bottom-0 w-full h-0.5 bg-primary transform origin-left scale-x-0 transition-transform duration-300 group-hover:scale-x-100" />
        </span>
      ...
      <Link href="#contact" className="block text-xs sm:text-sm relative group">
        <span className="relative text-foreground hover:text-primary transition-colors">
          お問い合わせ
          <span className="absolute left-0 bottom-0 w-full h-0.5 bg-primary transform origin-left scale-x-0 transition-transform duration-300 group-hover:scale-x-100" />
        </span>
